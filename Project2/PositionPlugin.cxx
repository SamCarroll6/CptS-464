    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_sample) {
        ...
        if (!RTICdrStream_serializeString(
            stream, sample->timestamp, ((Len)) + 1)) {
            return RTI_FALSE;
        }

        if (!RTICdrStream_serializeString(
            stream, sample->route, ((Len)) + 1)) {
            return RTI_FALSE;
        }

        if (!RTICdrStream_serializeString(
            stream, sample->vehicle, ((Len)) + 1)) {
            return RTI_FALSE;
        }
        ...
        if (!RTICdrStream_serializeString(
            stream, sample->trafficConditions, ((Len)) + 1)) {
            return RTI_FALSE;
        }
    ...
    try {
        ...
        if(deserialize_sample) {
            ...
            if (!RTICdrStream_deserializeStringEx(
                stream,&sample->timestamp, ((Len)) + 1, RTI_FALSE)) {
                goto fin; 
            }
            if (!RTICdrStream_deserializeStringEx(
                stream,&sample->route, ((Len)) + 1, RTI_FALSE)) {
                goto fin; 
            }
            if (!RTICdrStream_deserializeStringEx(
                stream,&sample->vehicle, ((Len)) + 1, RTI_FALSE)) {
                goto fin; 
            }
            ...
            if (!RTICdrStream_deserializeStringEx(
                stream,&sample->trafficConditions, ((Len)) + 1, RTI_FALSE)) {
                goto fin; 
            }
            if (!RTICdrStream_deserializeLong(
                stream, &sample->fillInRatio)) {
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (skip_sample) {
        ...
        if (!RTICdrStream_skipString (stream, ((Len))+1)) {
            goto fin; 
        }
        if (!RTICdrStream_skipString (stream, ((Len))+1)) {
            goto fin; 
